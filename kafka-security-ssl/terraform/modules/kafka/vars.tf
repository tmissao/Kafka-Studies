...
variable "ssl_certificate_secret" { default = "serversecret" }
variable "ssl_certificate_base64" { default = null}
variable "ssl_certificate_private_key_base64" { default = null }
